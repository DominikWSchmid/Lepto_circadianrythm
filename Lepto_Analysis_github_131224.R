...
vegan::rarecurve(t(tab), step = 20,  col = "black", 
                 cex = 0.1, main = "Rarefaction curve",
                 label=F, 
                 ylab = "Observed Number of Bacterial ASVs", 
                 xlab = "Sample Sequencing Depth"#, xlim=c(0,100000)
                 )
options(scipen = "scipen") # Restores scientific notation
...
##### calculation of alpha for all 179 samples ####
...
Observed_gam_rarefied <- mgcv::gam(Shannon~
                            treatment+ day + s(Seq_depth_scaled) +
                            s(time_point, by = treatment, bs = "cc"),
                          data=meta.gam,
                          family = gaussian, REML=T)
...
adonis2(dist_wUni ~ treatment*time_point + day + Seq_depth_scaled, data = meta, method="weighted unifrac", by="margin")
...
D1T1<-subset(treatment, day=="1" & time_point=="1")

D1T1_plot<-ggplot(D1T1, aes(Sample, 
                                               y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
        ...
        legend.title = element_text(colour = 'black', face="bold", size=12))+labs(fill ="Bacterial Genus")+
  ylab("Relative Abundance")+xlab("day time (24hours)")+
  theme(axis.title.x = element_blank())+scale_y_continuous(expand = c(0,0))+facet_grid(~time_point)

D1T5_plot<-ggplot(D1T1, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_blank()+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
  ...
  theme(axis.title.x = element_blank(), 
        axis.text.x = element_blank(), axis.title.y = element_blank())+scale_y_continuous(expand = c(0,0))

D1T3<-subset(treatment, day=="1" & time_point=="3")

D1T3_plot<-ggplot(D1T3, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
        ...
        legend.title = element_text(colour = 'black', face="bold", size=12))+labs(fill ="Bacterial Genus")+
  ylab("Relative Abundance")+xlab("day time (24hours)")+
  theme(axis.title.x = element_blank(), axis.title.y = element_blank())+scale_y_continuous(expand = c(0,0))+facet_grid(~time_point)

D1T7<-subset(treatment, day=="1" & time_point=="7")

D1T7_plot<-ggplot(D1T7, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T9<-subset(treatment, day=="1" & time_point=="9")

D1T9_plot<-ggplot(D1T9, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T11<-subset(treatment, day=="1" & time_point=="11")

D1T11_plot<-ggplot(D1T11, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T13<-subset(treatment, day=="1" & time_point=="13")

D1T13_plot<-ggplot(D1T13, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T15<-subset(treatment, day=="1" & time_point=="15")

D1T15_plot<-ggplot(D1T15, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T17<-subset(treatment, day=="1" & time_point=="17")

D1T17_plot<-ggplot(D1T17, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T19<-subset(treatment, day=="1" & time_point=="19")

D1T19_plot<-ggplot(D1T19, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T21<-subset(treatment, day=="1" & time_point=="21")

D1T21_plot<-ggplot(D1T21, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D1T23<-subset(treatment, day=="1" & time_point=="23")

D1T23_plot<-ggplot(D1T23, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T1<-subset(treatment, day=="3" & time_point=="1")

D2T1_plot<-ggplot(D2T1, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T3<-subset(treatment, day=="3" & time_point=="3")

D2T3_plot<-ggplot(D2T3, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T5<-subset(treatment, day=="3" & time_point=="5")

D2T5_plot<-ggplot(D2T5, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T7<-subset(treatment, day=="3" & time_point=="7")

D2T7_plot<-ggplot(D2T7, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T9<-subset(treatment, day=="3" & time_point=="9")

D2T9_plot<-ggplot(D2T9, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T11<-subset(treatment, day=="3" & time_point=="11")

D2T11_plot<-ggplot(D2T9, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_blank()+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
        ...
        legend.title = element_text(colour = 'black', face="bold", size=12))+labs(fill ="Bacterial Genus")+
  ylab("Relative Abundance")+xlab("day time (24hours)")+
  theme(axis.title.x = element_blank(), axis.text.x = element_blank(), axis.title.y = element_blank())+scale_y_continuous(expand = c(0,0))

D2T13<-subset(treatment, day=="3" & time_point=="13")

D2T13_plot<-ggplot(D2T13, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T15<-subset(treatment, day=="3" & time_point=="15")

D2T15_plot<-ggplot(D2T15, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T17<-subset(treatment, day=="3" & time_point=="17")

D2T17_plot<-ggplot(D2T17, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T19<-subset(treatment, day=="3" & time_point=="19")

D2T19_plot<-ggplot(D2T19, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T21<-subset(treatment, day=="3" & time_point=="21")

D2T21_plot<-ggplot(D2T21, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
D2T23<-subset(treatment, day=="3" & time_point=="23")

D2T23_plot<-ggplot(D2T23, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
ggarrange(D1T1_plot, D1T3_plot, D1T5_plot, D1T7_plot, D1T9_plot, D1T11_plot, D1T13_plot, D1T15_plot, D1T17_plot, D1T19_plot, D1T21_plot, D1T23_plot,
          D2T1_plot, D2T3_plot, D2T5_plot, D2T7_plot, D2T9_plot, D2T11_plot, D2T13_plot, D2T15_plot, D2T17_plot, D2T19_plot, D2T21_plot, D2T23_plot,
  #labels = c("A", "B"),
  nrow=2, ncol=12, align = c("h"),
  common.legend = TRUE, legend = "bottom"
)

control<-subset(genus_by_treat_time, treatment=="C")

CD1T1<-subset(control, day=="1" & time_point=="1")

CD1T1_plot<-ggplot(CD1T1, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T5<-subset(control, day=="1" & time_point=="5")

CD1T5_plot<-ggplot(CD1T5, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T3<-subset(control, day=="1" & time_point=="3")

CD1T3_plot<-ggplot(CD1T3, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T7<-subset(control, day=="1" & time_point=="7")

CD1T7_plot<-ggplot(CD1T7, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T9<-subset(control, day=="1" & time_point=="9")

CD1T9_plot<-ggplot(CD1T9, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T11<-subset(control, day=="1" & time_point=="11")

CD1T11_plot<-ggplot(CD1T11, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T13<-subset(control, day=="1" & time_point=="13")

CD1T13_plot<-ggplot(CD1T13, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T15<-subset(control, day=="1" & time_point=="15")

CD1T15_plot<-ggplot(CD1T15, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T17<-subset(control, day=="1" & time_point=="17")

CD1T17_plot<-ggplot(CD1T17, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T19<-subset(control, day=="1" & time_point=="19")

CD1T19_plot<-ggplot(CD1T19, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T21<-subset(control, day=="1" & time_point=="21")

CD1T21_plot<-ggplot(CD1T21, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD1T23<-subset(control, day=="1" & time_point=="23")

CD1T23_plot<-ggplot(CD1T23, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T1<-subset(control, day=="3" & time_point=="1")

CD2T1_plot<-ggplot(CD2T1, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T3<-subset(control, day=="3" & time_point=="3")

CD2T3_plot<-ggplot(CD2T3, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T5<-subset(control, day=="3" & time_point=="5")

CD2T5_plot<-ggplot(CD2T5, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T7<-subset(control, day=="3" & time_point=="7")

CD2T7_plot<-ggplot(CD2T7, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T9<-subset(control, day=="3" & time_point=="9")

CD2T9_plot<-ggplot(CD2T9, aes(Sample, 
                            y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T11<-subset(control, day=="3" & time_point=="11")

CD2T11_plot<-ggplot(CD2T11, aes(Sample, 
                             y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T13<-subset(control, day=="3" & time_point=="13")

CD2T13_plot<-ggplot(CD2T13, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T15<-subset(control, day=="3" & time_point=="15")

CD2T15_plot<-ggplot(CD2T15, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T17<-subset(control, day=="3" & time_point=="17")

CD2T17_plot<-ggplot(CD2T17, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T19<-subset(control, day=="3" & time_point=="19")

CD2T19_plot<-ggplot(CD2T19, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T21<-subset(control, day=="3" & time_point=="21")

CD2T21_plot<-ggplot(CD2T21, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
CD2T23<-subset(control, day=="3" & time_point=="23")

CD2T23_plot<-ggplot(CD2T23, aes(Sample, 
                              y = Abundance, fill = Genus_plot))+
  geom_col(size = 0, position = "fill")+ 
  theme_classic()+scale_fill_manual(values=c( "#A97092", "#C28CAE", "#DEC4A1", "#EBBB54","#EDEB7A", "#A3D186", "#76B19B","grey65"))+
  theme(axis.text.x = element_text(size = 10, angle=90, vjust=0.5), 
...
ggarrange(CD1T1_plot, CD1T3_plot, CD1T5_plot, CD1T7_plot, CD1T9_plot, CD1T11_plot, CD1T13_plot, CD1T15_plot, CD1T17_plot, CD1T19_plot, CD1T21_plot, CD1T23_plot,
          CD2T1_plot, CD2T3_plot, CD2T5_plot, CD2T7_plot, CD2T9_plot, CD2T11_plot, CD2T13_plot, CD2T15_plot, CD2T17_plot, CD2T19_plot, CD2T21_plot, CD2T23_plot,
          #labels = c("A", "B"),
          nrow=2, ncol=12, align = c("h"),
          common.legend = TRUE, legend = "bottom"
)
